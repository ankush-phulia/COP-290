...
public class View_complaint extends Fragment {
    ...
    public View onCreateView(
        ...
        if (getArguments().getString("type").equals("Pending Complaints Made")
                || getArguments().getString("type").equals("Pending Complaints Received")) {
            resolved = "Resolved";
        } else {
            resolved = "Pending";
        }
                                                ...
                                                new StringRequest(
                                                        ...
                                                        new Response.Listener<String>() {
                                                            ...
                                                            public void onResponse(
                                                                    String response) {
                                                                // receive reply from server and
                                                                // display it to the user as
                                                                // appropriate
                                                    ...
                                                    // putting the parameters as key-value pairs to
                                                    // pass
                                                    @Override
        ...
        upvotes.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        votes.setText(
                                String.valueOf(Integer.parseInt(votes.getText().toString()) + 1));
                    }
                });
        ...
        if (loggeduser.equals(receiver)
                && resolved.equals("Pending")
