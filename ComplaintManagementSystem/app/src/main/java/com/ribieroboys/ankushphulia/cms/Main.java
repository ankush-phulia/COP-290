...
public class Main extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final Intent intent =
                                new Intent(getApplicationContext(), New_complaint.class);
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.MainFragments, firstFragment)
                .commit();
                ...
                new StringRequest(
                                        ...
                                        new ExpandableListView.OnChildClickListener() {
                                            ...
                                            public boolean onChildClick(
                                                ...
                                                FragmentTransaction transaction =
                                                        getSupportFragmentManager()
                                                                .beginTransaction();
                                                switch (adapter.getGroup(groupPosition)
                                                        .items
                                                        .get(childPosition)
                                                        .title) {
                                                    case "Personal":
                                                        ...
                                                        ComplList.putString(
                                                                ...
                                                                adapter.getGroup(groupPosition)
                                                                        .title);
                                                        ComplList.putString(
                                                                "cjson", complaint_list);
                                                        ComplList.putString(
                                                                "user",
                                                                profileInfo.getString(
                                                                        "username", " "));
                                                        ComplList.putBundle(
                                                        ...
                                                        transaction.replace(
                                                                R.id.MainFragments, fragPersonal);
                                                        transaction.commit();
                                                        drawer.closeDrawers();
                                                        return true;
                                                    ...
                                                    case "Department Level":
                                                        ...
                                                        transaction.replace(
                                                                R.id.MainFragments, fragDepartment);
                                                        transaction.commit();
                                                        drawer.closeDrawers();
                                                        return true;
                                                    case "Institute Level":
                                                        ...
                                                        transaction.replace(
                                                                R.id.MainFragments, fragInstitute);
                                                        transaction.commit();
                                                        drawer.closeDrawers();
                                                        return true;
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(Main.this, "Connection Error", Toast.LENGTH_LONG)
                                        .show();
                            }
                        });
