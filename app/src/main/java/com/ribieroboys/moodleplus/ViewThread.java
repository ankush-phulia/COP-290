...
public class ViewThread extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setText() {
        try {
            ...
            for(int commentNo=0; commentNo < commentsJSON.length(); commentNo++) {
                ...
                textToSet += temp.getString("first_name") + " " + temp.getString("last_name") + "\t";
    ...
    public void onClick(View view) {
        if (view == postComment) {
            String commentURL = url + "/threads/post_comment.json?thread_id=" + threadID + "&description=" + commentToAdd.getText();
            StringRequest getReq = new StringRequest(Request.Method.GET,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(ViewThread.this, "Connection Error", Toast.LENGTH_LONG).show();
                        }
                    });
